 ...
 */
@WebServlet("/admin/EvaulateDelete")
public class EvaulateDelete extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		boolean flag = new AdminEvaluateService().delete(OID, ISBN);

		out.print("<script>alert('删除" + (flag ? "成功" : "失败") + "!');window.top.location.href='EvaluateShow';</script>");
