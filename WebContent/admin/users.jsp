...
<%@page import="com.youshu.admin.bean.UserBean"%>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<title>有书网后台 - 用户管理</title>
<%-- 基本模型 --%>
<meta charset="UTF-8">
	...
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-body">
			<fieldset class="layui-elem-field layui-field-title">
				<legend style="font-weight: normal">用户管理</legend>
			</fieldset>
				...
				<div class="layui-col-xs12">
					...
					<div class="layui-card">
						...
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-xs12">
								<form class="layui-form" action="UserSearch" method="post">
							...
							<div class="layui-col-xs12">
								<table lay-filter="table">
									<thead>
										<tr>
											<th
												lay-data="{field : 'UID',title : '#',sort : true,type : 'numbers',fixed : 'left'}"></th>
											<th
												lay-data="{field:'Status',width:50,type:'checkbox',fixed : 'left'}"></th>
											<th lay-data="{field:'test1',sort : true,title:'用户账号',minWidth:100}"></th>
											<th lay-data="{field:'test2',sort : true,title:'用户名',minWidth:100}"></th>
											<th lay-data="{field:'test3',sort : true,title:'性别',minWidth:100}"></th>
											<th
												lay-data="{title : '操作',width : 80,toolbar : '#tableBar',unresize : true,align : 'center',fixed : 'right'}"></th>
										</tr>
									</thead>
									<tbody>
										<%
					...
					<div class="layui-card">
						...
						<div class="layui-card-body layui-row layui-col-space10">
							<div class="layui-col-xs12">
								<form class="layui-form" action="UserDelete" lay-filter=""
